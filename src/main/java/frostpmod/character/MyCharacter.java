...
import static frostpmod.BasicMod.characterPath;
import static frostpmod.BasicMod.makeID;
...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Primal"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass PRIMAL_CHR;
        @SpireEnum(name = "FROST_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "FROST_COLOR") @SuppressWarnings("unused")
    ...
    public MyCharacter() {
        super(getNames()[0], Meta.PRIMAL_CHR,
